...
// before we found a number greater than .75.
	...
	function randomGame() {
		...
		var timer = setInterval(function() {
			...
			if (num > 0.75) {
				clearInterval(timer);
				console.log('It took ' + counter + ' seconds long to find a number greater than 0.75');
			}
		}, 1000);
	}
...
// Number Fact
// Write a function called numberFact which takes in a number
// and a callback and returns the result of the callback with the number passed to it
...
// Find
// Write a function called find. It should take in an array
// and a callback and return the first value found in the array that matches the condition.
...
// can later be passed another parameter to return the product.
